package com.cysewska.advertisement;

import com.cysewska.advertisement.config.ApplicationProperties;
import com.cysewska.advertisement.config.DefaultProfileUtil;
...
public class AdvertisementApp {
    ...
    private static final Logger log = LoggerFactory.getLogger(AdvertisementApp.class);

    private final Environment env;

    public AdvertisementApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes AdvertisementApp.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(AdvertisementApp.class);
